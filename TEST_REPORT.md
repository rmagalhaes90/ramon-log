...
| Unitários (`vitest run`) | **PASS**, 2 arquivos e 4 testes, código 0. |
| Build (`vite build --config vite.config.ts`) | **PASS**, 111 módulos; JS 484,02 kB (143,67 kB gzip), CSS 2,74 kB, código 0. |
