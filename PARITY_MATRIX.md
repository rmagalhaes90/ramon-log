...
| Treinos/rotinas/exercícios/séries |       ✅ |  🟡 | Telas de Treino (execução) e Rotina (montagem/edição) separadas como no baseline; vídeo do YouTube em modal embutido (170 links portados); edição de séries/reps/descanso movida para a tela de Rotina; celebração com confete/sequência ao finalizar; gerador automático por grupo muscular/equipamento/intensidade somado aos três templates fixos existentes; cronômetro da sessão só inicia por ação do usuário (nunca ao abrir a tela) e dias/semana sem rotina mostram onboarding em vez de tela vazia contando tempo (novo, alpha.41); séries, notas, timers com pausa, descanso cancelável, aquecimento, anilhas, e1RM, PR e rascunho recuperável; drag-and-drop por toque em iOS/Android segue pendente |
