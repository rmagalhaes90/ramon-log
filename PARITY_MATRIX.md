...
| Nutrição/barcode/suplementos | ✅ | 🟡 | Refeições, macros, água, suplementos, consulta GTIN e câmera nativa com fallback manual; falta edição avançada de horários |
...
| Offline/fila | ✅ | 🟡 | Cache/fila, rascunho de treino e fila limitada de JPEGs em IndexedDB com retomada automática; faltam conflitos multi-dispositivo e gestão de quota |
...
Percentual estimado da migração funcional: **84%**. A estimativa pondera paridade de comportamento e validação, não apenas quantidade de arquivos.
...
| Progresso, readiness e nutrição | 88% | Peso, gráfico, medidas, readiness, suplementos e barcode manual/câmera implementados |
...
| Offline, sincronização e PWA | 80% | IndexedDB v2, filas de documentos/fotos, cache e recuperação de treino ativos; faltam conflitos multi-dispositivo, quota e validação iOS prolongada |
