...
| Treinos/rotinas/exercícios/séries |       ✅ |  🟡 | Catálogo completo com os 170 links de vídeo do YouTube portados do baseline, edição de séries/reps/descanso por exercício, reordenação por botões (acessível/mobile) e drag-and-drop nativo para mouse/desktop, três templates/gerador, séries, notas, timers com pausa, descanso cancelável, aquecimento, anilhas, e1RM, PR e rascunho recuperável; drag-and-drop por toque em iOS/Android segue pendente (HTML5 DnD não cobre touch) |
