...
Atualizado em 2026-08-03 após `4.0.0-alpha.21`.
...
| Mobile iOS/Android                     |      20% |       78% |           15,60% | Auth, treino, readiness, escrita offline, fotos privadas, comparação e compartilhamento; notificações ainda parciais. |
...
| **Total geral**                        | **100%** |           | **83,20% ≈ 83%** | Medição do escopo ampliado Web + Admin + Mobile + Firebase.                                                           |
