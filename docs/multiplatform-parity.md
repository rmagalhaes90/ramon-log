...
Atualizado em 2026-08-03 após `4.0.0-alpha.18`.
...
| Mobile iOS/Android                     |      20% |       62% |           12,40% | Auth, dashboard, treino ativo recuperável e escrita offline de progresso, água e suplementos; fotos e notificações pendentes. |
...
| **Total geral**                        | **100%** |           | **79,50% ≈ 80%** | Medição do escopo ampliado Web + Admin + Mobile + Firebase.                                                                   |
