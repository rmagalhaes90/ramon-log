...
Atualizado em 2026-08-03 após `4.0.0-alpha.25`.
...
| Mobile iOS/Android                     |      20% |       92% |           18,40% | Fluxos centrais, admin protegido, offline, mídia, alertas, PT/EN parcial, conta e recuperação de erro.                |
...
| **Total geral**                        | **100%** |           | **89,90% ≈ 90%** | Medição do escopo ampliado Web + Admin + Mobile + Firebase.                                                           |
