...
Atualizado em 2026-08-03 após `4.0.0-alpha.17`.
...
| Mobile iOS/Android                     |      20% |       53% |           10,60% | Auth, dashboard, leitura e escrita offline de progresso, água e suplementos; treinos ativos, fotos e notificações pendentes. |
...
| **Total geral**                        | **100%** |           | **77,70% ≈ 78%** | Medição do escopo ampliado Web + Admin + Mobile + Firebase.                                                                  |
